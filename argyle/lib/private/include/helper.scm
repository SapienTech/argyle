#!r6rs
;;; helper.sls --- Helper procedures for (argyle lib private include)
...
(library (argyle lib private include helper)
  (export include-file/aux)
  (import (rnrs)
          (argyle lib private include utils)
          (argyle lib private include filesys)
          (for (argyle lib private include compat) run (meta -1)))
